...
import com.example.andelachallenge.activities.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(DeveloperDetailFragment.ARG_ITEM, holder.mItem.id);
                        ...
                        intent.putExtra(DeveloperDetailFragment.ARG_ITEM, holder.mItem.id);
